...
def run_snic(path_to_png, numsuperpixels, compactness):
	"""
	Set parameters and call the C function
    
	Before calling this function, please compile the C code using
	   "python compile_snic_lib.py" on the command line
	"""
	doRGBtoLAB = True  # only works if it is a three channel image
	
	labels, numlabels = segment(path_to_png, numsuperpixels, compactness, doRGBtoLAB)
	labels = labels + 1
...
if __name__ == '__main__':
	run_snic('./orig_images/test.png', 100, 10)
